...
add wave -noupdate -group UPA /sim_system/UUT/Accelerator_Unit/PLANE_GEN(0)/Processing_Plane/ROW_GEN(1)/COL_GEN(1)/UA_unit/CU/clk_w
add wave -noupdate -group UPA /sim_system/UUT/Accelerator_Unit/PLANE_GEN(0)/Processing_Plane/ROW_GEN(1)/COL_GEN(1)/UA_unit/CU/rst_w
...
add wave -noupdate -group STA /sim_system/UUT/Accelerator_Unit/PLANE_GEN(0)/Processing_Plane/ROW_GEN(1)/COL_GEN(1)/SA_unit/clk_w
...
add wave -noupdate -group STA /sim_system/UUT/Accelerator_Unit/PLANE_GEN(0)/Processing_Plane/ROW_GEN(1)/COL_GEN(1)/SA_unit/rst_w
...
add wave -noupdate -group OGV /sim_system/UUT/Accelerator_Unit/LMN_ROW_GEN(0)/LMN_COL_GEN(0)/Local_Memory_Node/OGM_2VCU/TLB_add_in
add wave -noupdate -group OGV /sim_system/UUT/Accelerator_Unit/LMN_ROW_GEN(0)/LMN_COL_GEN(0)/Local_Memory_Node/OGM_2VCU/TLB_add_out
