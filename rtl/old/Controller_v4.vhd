...
architecture Behavioral of Controller_v4 is
	--------------------------------------------------------------------------
	--------------------------------------------------------------------------
	--		COMPONENTS
	--------------------------------------------------------------------------
	...
	SIGNAL	FSM_Rows_inc				:	std_logic_vector(3	DOWNTO	0);
	SIGNAL	FSM_Cntr_inc				:	std_logic_vector(3	DOWNTO	0);
	SIGNAL	FSM_Bank_inc				:	std_logic_vector(3	DOWNTO	0);
	SIGNAL	FSM_GBMs_inc				:	std_logic_vector(3	DOWNTO	0);
...
begin
	...
	PORT	MAP(
		...
		Rows_inc						=>	FSM_Rows_inc	(0),
		Cntr_inc						=>	FSM_Cntr_inc	(0),
		Bank_inc						=>	FSM_Bank_inc	(0),
		GBMs_inc						=>	FSM_GBMs_inc	(0),
	...
	PORT	MAP(
		...
		Rows_inc						=>	FSM_Rows_inc	(1),
		Cntr_inc						=>	FSM_Cntr_inc	(1),
		Bank_inc						=>	FSM_Bank_inc	(1),
		GBMs_inc						=>	FSM_GBMs_inc	(1),
	...
	Rows_inc							<=	FSM_Rows_inc	(0)		WHEN	CNF_FSM_sel = "00"	ELSE	FSM_Rows_inc	(1)		WHEN	CNF_FSM_sel = "01"	ELSE	FSM_Rows_inc	(2)		WHEN	CNF_FSM_sel = "10"	ELSE	FSM_Rows_inc	(3);
	Cntr_inc							<=	FSM_Cntr_inc	(0)		WHEN	CNF_FSM_sel = "00"	ELSE	FSM_Cntr_inc	(1)		WHEN	CNF_FSM_sel = "01"	ELSE	FSM_Cntr_inc	(2)		WHEN	CNF_FSM_sel = "10"	ELSE	FSM_Cntr_inc	(3);
	Bank_inc_all						<=	FSM_Bank_inc	(0)		WHEN	CNF_FSM_sel = "00"	ELSE	FSM_Bank_inc	(1)		WHEN	CNF_FSM_sel = "01"	ELSE	FSM_Bank_inc	(2)		WHEN	CNF_FSM_sel = "10"	ELSE	FSM_Bank_inc	(3);
	GBMs_inc							<=	FSM_GBMs_inc	(0)		WHEN	CNF_FSM_sel = "00"	ELSE	FSM_GBMs_inc	(1)		WHEN	CNF_FSM_sel = "01"	ELSE	FSM_GBMs_inc	(2)		WHEN	CNF_FSM_sel = "10"	ELSE	FSM_GBMs_inc	(3);
