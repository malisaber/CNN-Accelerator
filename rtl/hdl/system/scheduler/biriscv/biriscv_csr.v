...
(
	...
	//	Added by me
    ,output			 On_Tmporary_o
    ,output			 Clear_Tmporary_o
	//	End of addition
);
...
wire [31:0] TMP_csrrw_w ;
wire [31:0] TMP_csrrs_w ;
wire [31:0] TMP_csrrc_w ;
wire [31:0] TMP_csrrwi_w;
wire [31:0] TMP_csrrsi_w;
wire [31:0] TMP_csrrci_w;

assign TMP_csrrw_w        = (opcode_opcode_i & `INST_CSRRW_MASK) ;
assign TMP_csrrs_w        = (opcode_opcode_i & `INST_CSRRS_MASK) ;
assign TMP_csrrc_w        = (opcode_opcode_i & `INST_CSRRC_MASK) ;
assign TMP_csrrwi_w       = (opcode_opcode_i & `INST_CSRRWI_MASK);
assign TMP_csrrsi_w       = (opcode_opcode_i & `INST_CSRRSI_MASK);
assign TMP_csrrci_w       = (opcode_opcode_i & `INST_CSRRCI_MASK);
...
//	Added by me
wire	On_Tmporary_w;
wire	Clear_Tmporary_w;

assign	On_Tmporary_o			=	On_Tmporary_w;
assign	Clear_Tmporary_o		=	Clear_Tmporary_w;
//	End of addition
...
(
	...
	//	Hardware Content Switching
	//	Added by me
    ,.On_Tmporary_o(On_Tmporary_w)
    ,.Clear_Tmporary_o(Clear_Tmporary_w)
	//	End of addition
