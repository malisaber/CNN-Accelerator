...
end Cont_add_unit_v3;

architecture Behavioral of Cont_add_unit_v3 is
	--------------------------------------------------------------------------
	--------------------------------------------------------------------------
	--		COMPONENTs
	--------------------------------------------------------------------------
	COMPONENT	Controller_v5 is
	PORT(
		clk								:	IN	std_logic;
		rst								:	IN	std_logic;
		--	Config Signals
